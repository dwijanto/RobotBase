...
{
 protected:
	 uint8_t readRegister(uint8_t req, uint8_t* buf, uint8_t len);
	 uint8_t readRegister(uint8_t req);
	 uint8_t writeRegister(uint8_t req, const uint8_t* buf,uint8_t len);
	 uint8_t writeRegister(uint8_t req, uint8_t value);
	 uint8_t mCePin;
	 uint8_t mCsPin;
